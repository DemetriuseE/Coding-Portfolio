...
print(f"Thank you for responding so often as of today. I know that you are feeling {A7}, but i'd like to talk about how you got there.")
...
#Distant responses
print("Being in a position of understanding decision making processes is difficult. We often believe others will make the same decision as us.")
